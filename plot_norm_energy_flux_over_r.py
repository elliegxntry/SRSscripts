...
def plot_norm_energy_flux_over_r(config, specs, raw_data_path, reduced_data_path, times, **kwargs):
    """
    ...
    titstr = config
    titstr += "\n Energy flux (normalized to mass flux) through each radial shell"
...
if __name__ == '__main__':
    ...
    plot_norm_energy_flux_over_r(config, specs, raw_data_path, reduced_data_path, times)
